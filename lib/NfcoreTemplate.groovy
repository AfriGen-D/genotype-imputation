...
class NfcoreTemplate {
    ...
    public static void awsBatch(workflow, params) {
        if (workflow.profile.contains('awsbatch')) {
            assert params.awsqueue || params.process_queue : "Provide the AWS Batch job queue to submit to with --awsqueue or process.queue"
            assert params.awsregion || params.aws_region : "Provide AWS region with --awsregion or aws.region"
        }
    }
    ...
    //
    // Generate pipeline version string
    //
